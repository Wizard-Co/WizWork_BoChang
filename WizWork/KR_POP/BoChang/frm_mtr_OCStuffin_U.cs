...
namespace WizWork
{
    public partial class frm_mtr_OCStuffin_U : Form
    {
        ...
        public frm_mtr_OCStuffin_U()
        {
            InitializeComponent();
        }

        public frm_mtr_OCStuffin_U(string StuffinID, string LotID, string ArticleID, string InspectID)
        {
            InitializeComponent();
