...
namespace WizWork
{
    public partial class frm_mtr_OCStuffin_Q : Form
    {
        ...
        private void Reprint(DataGridViewRow dgvsr)
        {
            ...
            try
            {
                ...
                frm_mtr_OCStuffin_U fmocs = new frm_mtr_OCStuffin_U();
        ...
        private void UpdateSave()
        {
            ...
            frm_mtr_OCStuffin_U child1 = new frm_mtr_OCStuffin_U(StuffinID, LotID, ArticleID, InspectID);
            form = child1;
